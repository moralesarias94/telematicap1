...
var payment_submit = document.querySelector("#add_payment");
var desc = document.querySelector("#transaction_desc");
var value = document.querySelector("#transaction_value");
var type = document.querySelector("#transaction_type");
var deposit_desc = document.querySelector("#deposit_desc");
var deposit_value = document.querySelector("#deposit_value");
var deposit_type = document.querySelector("#deposit_type");
var deposit_submit = document.querySelector("#add_deposit");
var deposit_wallet_id = document.querySelector("#deposit_wallet");
var transaction_wallet_id = document.querySelector("#transaction_wallet");

deposit_submit.addEventListener("click", function (event) {
...
payment_submit.addEventListener("click", function (event) {
...
channel.on("new_transaction", function (payload) {
  var icon = "";
  ...
  $('#transactions_list').append('<li><div class="collapsible-header"<p><i class="material-icons">' + icon + '</i>' + payload.body.desc + '</p></div><div class="collapsible-body"><p>' + payload.body.value + '</p></div></li>');
